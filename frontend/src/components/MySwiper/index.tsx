...
function MatchingPage() {
  ...
  const calculateZoom = useCallback((distanceKm) => {
  ...
  return (
    <div className="container mx-auto px-4 py-6">
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                    ...
                    <div className="mb-3">
                      <div className="flex flex-wrap gap-2">
                        {selectedInterests.map((interest) => (
                          <Badge
                            key={interest.id}
                            className="bg-red-500 hover:bg-red-600 cursor-pointer flex items-center gap-1 px-3 py-1"
        ...
        {/* Matches Display */}
        <div className="lg:col-span-2 flex flex-col items-center justify-start min-h-[70vh]">
          <div className="relative w-full max-w-md h-[550px] flex items-center justify-center">
            {isLoading ? (
              ...
              <AnimatePresence>
                ...
                >
                  <motion.div
                    className="card bg-white dark:bg-gray-800 rounded-xl shadow-xl overflow-hidden"
